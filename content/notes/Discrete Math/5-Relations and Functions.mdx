...
# 5.5 Function Properties

## Injective Functions (One-to-one)
Are functions whose domain elements map to at most one distinct element in the 
codomain.

## Surjective Functions (Onto)
Are functions whose domain elements map to at least one distinct element in 
the codomain.

## Bijective Functions (One-to-one correspondence)
Are functions that are both injective and surjective.

## Inverse Functions
Are bijective functions whose domain and codomain are in reverse order.

# 5.6 Denumerables

## Denumerables
Are sets that have the same cardinality as the cardinality of all positive integers.
...
## Countable Sets
Are sets that are finite or denumerable.

## Uncountable Sets
Are infinite sets that are not denumerable.